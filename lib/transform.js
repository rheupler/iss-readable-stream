...
function DeltaStream(id, rate){
  ...
  /**
   * Need to use Location Stream for getting data, specifically lat/long
   */
 ...
 * If data is available from the resource, it will begin pushing that data into the read queue
 */
